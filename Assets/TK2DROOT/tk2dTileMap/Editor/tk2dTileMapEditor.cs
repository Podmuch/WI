...
public class tk2dTileMapEditor : Editor, ITileMapEditorHost
{
	...
	void DrawSettingsPanel()
	{
		...
		// Tilemap data
		tk2dTileMapData newData = (tk2dTileMapData)EditorGUILayout.ObjectField("Tile MapPage Data", tileMap.data, typeof(tk2dTileMapData), false);
		...
		if (tileMap.data == null)
		{
			if (tk2dGuiUtility.InfoBoxWithButtons(
				...
				"Create") != -1)
			{
				string assetPath = EditorUtility.SaveFilePanelInProject("Save Tile MapPage Data", "tileMapData", "asset", "");
		...
		if (editorData == null)
		{
			if (tk2dGuiUtility.InfoBoxWithButtons(
				...
				"Create") != -1)
			{
				string assetPath = EditorUtility.SaveFilePanelInProject("Save Tile MapPage Editor Data", "tileMapEditorData", "asset", "");
				if (assetPath.Length > 0)
				{
#if (UNITY_3_5 || UNITY_4_0 || UNITY_4_0_1 || UNITY_4_1 || UNITY_4_2)
